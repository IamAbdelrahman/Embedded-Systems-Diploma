...
int RetrieveList(List_t *, void (*)(LISTENTRY *));
int RetrieveListFromEnd(List_t *, void (*)(LISTENTRY *));
int ReplaceList(List_t *, void (*)(LISTENTRY *));
int TraverseList(List_t *, void (*)(LISTENTRY *));
int MiddleList(List_t *, void (*)(LISTENTRY *));
