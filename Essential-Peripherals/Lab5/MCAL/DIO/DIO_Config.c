...
const ST_GpioConfig_t GpioConfig[] = {
    /*   PORT            PIN					STATE
     */
    {PORTA, Pin0, DIO_INPUT_FLOATING}, 
    {PORTA, Pin1, DIO_INPUT_FLOATING},
    {PORTA, Pin2, DIO_INPUT_FLOATING}, 
    {PORTA, Pin3, DIO_INPUT_FLOATING},
    {PORTA, Pin4, DIO_INPUT_FLOATING}, 
    {PORTA, Pin5, DIO_INPUT_FLOATING},
    {PORTA, Pin6, DIO_INPUT_FLOATING}, 
    {PORTA, Pin7, DIO_INPUT_FLOATING},
    {PORTB, Pin1, DIO_INPUT_FLOATING}, 
    {PORTB, Pin2, DIO_INPUT_FLOATING},
    {PORTB, Pin3, DIO_INPUT_FLOATING},
};
