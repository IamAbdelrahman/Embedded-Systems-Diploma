...
#define GPIOA2                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN2, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA3                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN3, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA4                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN4, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA5                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN5, GPIO_ALTERNATE_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA6                                                                 \
		(ST_GPIOConfig_t) {                                                          \
...
#define GPIOA7                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN7, GPIO_ALTERNATE_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA8                                                                 \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN8, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ      \
}
#define GPIOA9                                                                 \
		(ST_GPIOConfig_t) {                                                          \
...
#define GPIOA11                                                                \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN11, GPIO_ALTERNATE_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ     \
}
#define GPIOA12                                                                \
		(ST_GPIOConfig_t) {                                                          \
	PORTA, PIN12, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ     \
}
#define GPIOA13                                                                \
		(ST_GPIOConfig_t) {                                                          \
...
#define GPIOA15                                                                \
		(ST_GPIOConfig_t) {                                                    \
	PORTA, PIN15, GPIO_OUTPUT_PUSHPULL, GPIO_MAX_OUTPUT_MODE_SPEED_10MHZ     \
}

#define GPIOB0                                                                 \
		(ST_GPIOConfig_t) {                                                    \
	PORTB, PIN0, GPIO_INPUT_PULLDOWN, GPIO_MAX_OUTPUT_MODE_SPEED_DISABLED        \
}
#define GPIOB1                                                                 \
		(ST_GPIOConfig_t) {                                                    \
