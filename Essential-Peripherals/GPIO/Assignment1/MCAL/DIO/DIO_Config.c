...
/*   PORT            PIN					STATE			*/
    {PORTD,         Pin0,               DIO_INPUT_FLOATING},
    {PORTD,         Pin1,               DIO_INPUT_FLOATING},
    {PORTD,         Pin2,               DIO_INPUT_FLOATING},
    {PORTD,         Pin3,               DIO_INPUT_FLOATING},
    {PORTD,         Pin4,               DIO_OUTPUT},
    {PORTD,         Pin5,               DIO_OUTPUT},
    {PORTD,         Pin6,               DIO_OUTPUT},
    {PORTD,         Pin7,               DIO_OUTPUT}
};
